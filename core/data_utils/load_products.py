...
def _process():
    ...
    data = []
    files = [
        "dataset/ogbn_products/Amazon-3M.raw/trn.json",
    ...
    pd.DataFrame.to_csv(
        graph_df, FILE, index=False, columns=["uid", "nid", "title", "content"]
    )
